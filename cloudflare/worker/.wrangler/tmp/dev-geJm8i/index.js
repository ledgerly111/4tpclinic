...
function extractErrorMessage(error) {
  ...
  if (error.cause && typeof error.cause.message === "string" && error.cause.message) {
...
// .wrangler/tmp/bundle-OR4rfY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-OR4rfY/middleware-loader.entry.ts
