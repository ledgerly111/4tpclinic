            ...
            <nav className={cn(
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            <button onClick={() => scrollToSection('hero')} className="text-[#512c31]/70 hover:text-[#e8919a] transition-colors text-sm font-semibold">Features</button>
                ...
                <div className={cn(
                    ...
                    <div className="flex flex-col items-center gap-6 px-4 font-bold text-lg text-[#512c31]">
                        <button onClick={() => scrollToSection('hero')} className="w-full text-center py-2 hover:text-[#e8919a]">Features</button>
            ...
            <main id="hero" className="pt-24 sm:pt-28 lg:pt-32 pb-12 sm:pb-20 px-3 sm:px-4 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 sm:gap-4 lg:grid-rows-6 h-auto lg:h-[1200px]">
                    ...
                    <div className="lg:col-span-12 lg:row-span-1 bg-[#512c31] rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 flex items-center gap-4 sm:gap-6 group overflow-hidden relative order-1">
                        ...
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#fef9f3] tracking-tighter">4TP Clinic ERP</h2>
                    </div>
                    ...
                    <div className="lg:col-span-5 lg:row-span-1 bg-[#f0cbc1] rounded-3xl sm:rounded-[2.5rem] p-5 sm:p-6 flex items-center gap-4 sm:gap-6 overflow-hidden border-2 sm:border-4 border-[#512c31]/5 order-2">
                        <div className="flex-1">
                            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#512c31] leading-tight flex flex-wrap gap-1">
                                Decisions <span className="text-[#e8919a]">made simple</span> with <span className="opacity-80">Reports & Insights.</span>
                            </h3>
                        ...
                        <div className="hidden xs:block w-16 h-16 sm:w-24 sm:h-24 rounded-full bg-[#512c31]/10 flex-shrink-0 relative overflow-hidden">
                            <TrendingUp className="w-8 h-8 sm:w-12 sm:h-12 text-[#512c31]/40 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 lg:col-span-7 lg:row-span-3 bg-[#e8919a] rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 lg:p-10 flex flex-col justify-between relative overflow-hidden group min-h-[350px] sm:min-h-0 order-3">
                        ...
                        <div className="space-y-4 sm:space-y-6 relative z-10">
                            ...
                            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#fef9f3] leading-[0.9] tracking-tighter">
                                Total<br />Practice<br />Control<br />Center
                            </h1>
                            <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-2 sm:pt-4">
                                {['Patient CRM', 'Unified Billing', 'Smart Inventory', 'Advanced Rx'].map(tag => (
                    ...
                    <div className="sm:col-span-1 lg:col-span-4 lg:row-span-3 bg-white border-2 border-[#512c31]/5 rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-10 flex flex-col items-center justify-center text-center relative overflow-hidden group min-h-[350px] sm:min-h-0 order-4">
                        ...
                        <div className="relative z-10 space-y-4 sm:space-y-6">
                            <div className="grid grid-cols-2 gap-2 w-40 sm:w-48 mx-auto translate-y-2">
                                <span className="px-2 py-1 sm:px-3 sm:py-1.5 bg-[#512c31] text-[#fef9f3] rounded-lg text-[10px] sm:text-xs font-black rotate-[-12deg] shadow-lg uppercase">SERVICES</span>
                                <span className="px-2 py-1 sm:px-3 sm:py-1.5 bg-[#e8919a] text-[#fef9f3] rounded-lg text-[10px] sm:text-xs font-black rotate-[8deg] shadow-lg uppercase">BILLING</span>
                                <span className="px-2 py-1 sm:px-3 sm:py-1.5 bg-[#512c31] text-[#fef9f3] rounded-lg text-[10px] sm:text-xs font-black rotate-[-4deg] shadow-lg uppercase">INVENTORY</span>
                                <span className="px-2 py-1 sm:px-3 sm:py-1.5 bg-[#e8919a] text-[#fef9f3] rounded-lg text-[10px] sm:text-xs font-black rotate-[15deg] shadow-lg uppercase">STAFF</span>
                            </div>
                            ...
                            <div className="w-32 h-32 sm:w-40 sm:h-40 bg-[#f0cbc1] rounded-full mx-auto flex items-center justify-center border-4 border-white shadow-xl relative">
                                <ClipboardList className="w-12 h-12 sm:w-20 sm:h-20 text-[#512c31]/20" />
                            </div>

                            <div className="space-y-1 sm:space-y-2">
                                <h3 className="text-2xl sm:text-3xl font-black text-[#512c31] leading-none">Simplifying</h3>
                                <div className="inline-block px-3 py-1 bg-[#e8919a] text-[#fef9f3] rounded-lg text-xl sm:text-2xl font-black">Clinic</div>
                                <h3 className="text-2xl sm:text-3xl font-black text-[#512c31] leading-none">Operations</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-3 lg:row-span-2 bg-[#e8919a] rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 flex flex-col justify-center items-center relative overflow-hidden shadow-xl shadow-[#e8919a]/20 order-5">
                        <div className="w-32 h-32 sm:w-48 sm:h-48 border-[8px] sm:border-[12px] border-white/20 rounded-full flex flex-col items-center justify-center relative">
                            ...
                            <span className="text-3xl sm:text-5xl font-black text-white">100%<span className="text-xl opacity-60"></span></span>
                            <span className="text-[10px] font-bold text-white/80 uppercase tracking-widest mt-1">Practice Accuracy</span>
                        </div>
                    ...
                    <div className="lg:col-span-3 lg:row-span-3 bg-white border-2 border-[#512c31]/5 rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 flex flex-col justify-between overflow-hidden group order-7">
                        <div className="flex items-center justify-between">
                            <h4 className="text-[10px] font-black text-[#512c31]/30 uppercase tracking-[0.2em]">Secure Access</h4>
                        ...
                        <div className="space-y-2 my-6 sm:my-0">
                            <h3 className="text-2xl sm:text-3xl font-black text-[#512c31] leading-tight text-center sm:text-left">Role-Based System Security</h3>
                            <p className="text-[#512c31]/50 text-xs font-bold text-center sm:text-left">Admin, Staff & SuperAdmin Controls.</p>
                        </div>
                            ...
                            <div className="w-full aspect-[16/9] sm:aspect-[4/3] bg-[#f0cbc1] rounded-2xl sm:rounded-3xl relative overflow-hidden group-hover:rotate-1 transition-transform flex items-center justify-center">
                                ...
                                <div className="absolute inset-x-0 bottom-0 p-3 sm:p-4 bg-gradient-to-t from-[#512c31]/80 to-transparent">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-white text-[8px] sm:text-[10px] font-black uppercase tracking-widest leading-none">Enterprise Encryption</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-5 lg:row-span-2 bg-[#512c31] rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 flex flex-col justify-between group overflow-hidden order-8">
                        <h3 className="text-xl sm:text-2xl font-bold text-[#fef9f3] leading-tight max-w-[90%] text-center sm:text-left">Streamlined Booking and Unified Patient Care 😊</h3>

                        <div className="flex justify-center sm:justify-start gap-4 mt-6">
                            {[Calendar, Users2, Receipt].map((Icon, i) => (
            ...
            <section id="impact" className="py-16 sm:py-24 bg-[#512c31] relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-12 sm:mb-20">
                        <span className="text-[#e8919a] font-black uppercase tracking-[0.2em] text-xs sm:text-sm">ERP Impact</span>
                        <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-[#fef9f3] mt-4 mb-8 tracking-tighter leading-tight">Automate your clinic.<br className="hidden sm:block" /> Master your data.</h2>

                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mt-12 sm:mt-16">
                            {[
                                { val: '40%', label: 'TIME SAVED' },
                                { val: '100%', label: 'RECOGNITION' },
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-10 text-center md:text-left">
                        <div className="flex flex-col items-center md:items-start gap-4">
                            <div className="w-12 rounded-full bg-[#e8919a] flex items-center justify-center shadow-lg shadow-[#e8919a]/30 aspect-square">
                            ...
                            <div>
                                ...
                                <p className="text-[#512c31]/40 font-bold text-[10px] uppercase tracking-widest">Clinic ERP Excellence</p>
                            </div>
                        </div>

                        <div className="flex gap-12 sm:gap-16">
                            <div className="space-y-4">
                                <h5 className="font-black text-[#512c31] uppercase tracking-[0.2em] text-[10px]">Modules</h5>
                                <ul className="space-y-2 text-[#512c31]/50 font-bold text-xs uppercase cursor-pointer">
                                    <li onClick={() => navigate('/login')} className="hover:text-[#e8919a]">Billing</li>
                                    <li onClick={() => navigate('/login')} className="hover:text-[#e8919a]">Patients</li>
                                    <li onClick={() => navigate('/login')} className="hover:text-[#e8919a]">Inventory</li>
                                </ul>
                            </div>
                            <div className="space-y-4">
                                <h5 className="font-black text-[#512c31] uppercase tracking-[0.2em] text-[10px]">Support</h5>
                                <ul className="space-y-2 text-[#512c31]/50 font-bold text-xs uppercase cursor-pointer">
                                    <li onClick={() => scrollToSection('hero')} className="hover:text-[#e8919a]">Features</li>
                                    <li onClick={() => scrollToSection('impact')} className="hover:text-[#e8919a]">Impact</li>
                                    <li onClick={() => scrollToSection('footer')} className="hover:text-[#e8919a]">Contact</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="mt-16 pt-8 border-t border-gray-50 text-center text-[#512c31]/20 text-[8px] font-black tracking-[0.2em] uppercase">
                        © 2024 4 The People ERP • Healthcare Operations Refined
                    </div>
                </div>
            </footer>
